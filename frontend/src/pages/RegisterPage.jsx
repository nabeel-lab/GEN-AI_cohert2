    ...
    return (
        <div className="min-h-screen bg-background text-zinc-100 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                ...
                <h2 className="text-3xl font-medium tracking-tight text-zinc-100 mb-2">Create Account</h2>
                <p className="text-zinc-500 font-light mb-8">Join LaunchWise to analyze your startup ideas.</p>
